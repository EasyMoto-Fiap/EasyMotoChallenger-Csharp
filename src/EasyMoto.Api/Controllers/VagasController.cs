...
namespace EasyMoto.Api.Controllers
{
    ...
    public class VagasController : ControllerBase
    {
        ...
        [HttpGet("{id:guid}")]
        public async Task<IActionResult> GetById([FromServices] ObterVagaPorIdHandler handler, Guid id, CancellationToken ct = default)
        {
        ...
        [HttpPut("{id:guid}")]
        public async Task<IActionResult> Put([FromServices] AtualizarVagaHandler handler, Guid id, [FromBody] AtualizarVagaRequest req, CancellationToken ct = default)
        {
        ...
        [HttpDelete("{id:guid}")]
        public async Task<IActionResult> Delete([FromServices] ExcluirVagaHandler handler, Guid id, CancellationToken ct = default)
        {
