...
namespace EasyMoto.Application.Localizacoes
{
    public sealed class CriarLocalizacaoHandler
    {
        ...
        public CriarLocalizacaoHandler(ILocalizacaoRepository repo)
        {
            _repo = repo;
        }

        public async Task<LocalizacaoResponse> ExecuteAsync(CriarLocalizacaoRequest req, CancellationToken ct)
        {
